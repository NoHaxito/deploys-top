...
export function DesktopMenu() {
  ...
  return (
    <NavigationMenu className="hidden md:flex">
      <NavigationMenuList>
        <NavigationMenuItem className="flex flex-col" value="free-providers">
          <NavigationMenuTrigger className="h-8 bg-transparent">
            Free Providers
          </NavigationMenuTrigger>

          <NavigationMenuContent>
            <div className="grid lg:grid-cols-[auto_minmax(auto,1fr)] p-4 gap-3">
              <div className="rounded-lg h-48 lg:h-full lg:w-56 bg-accent/50 backdrop-blur"></div>
              <ul className="grid h-64 w-[300px] grid-cols-1 gap-1 overflow-y-auto lg:h-max lg:w-[500px] lg:grid-cols-2">
        ...
        {/* <NavigationMenuItem value="categories">
          ...
          <NavigationMenuContent>
            <ul className="grid h-64 w-[375px] grid-cols-2 gap-1 overflow-auto p-4 lg:h-max">
